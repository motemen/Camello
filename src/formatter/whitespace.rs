...
impl Formatter {
    pub(super) fn handle_newline(&mut self, source: LineBreakSource) {
        self.last_line_break_was_user = matches!(source, LineBreakSource::User);
        if self.last_line_break_was_user {

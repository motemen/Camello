...
///
/// Parsing is the caller's, because a caller that formats and checks the same
/// file should not parse it twice.
#[must_use]
pub fn check(root: &SyntaxNode, source: &str, options: &Options) -> Vec<Diagnostic> {
